...
COMMENT* Escribir un programa que saque en pantalla
        'Hola mi nombre es alan 3 veces'
...
DATOS   SEGMENT PARA 'DATA'                          ;Inicia Segmento de Datos
    ...
    Mensaje DB "Mi Nombre es Alan",07,13,10,'$'             ;defina la variable mensaje  07 sonido 13 salto de liena 10 retorno de posicion
...
Etiqueta_ciclo: 
        ...
        JNZ  Etiqueta_ciclo                    ;Salta a esa etiqueta si NO es cero "Z"
        JMP  Etiqueta_Fin_Ciclo                          ;si no se cumplio la anterior entonces ejecuta esta
